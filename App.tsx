        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center bg-slate-800 p-1 rounded-lg border border-slate-700">
            <button
              ...
              className={`p-1.5 rounded-md transition-colors ${!isPreview ? 'bg-blue-600 text-white shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-700'}`}
              title="Edit Mode"
            >
              <Edit size={16} />
            </button>
            <button
              ...
              className={`p-1.5 rounded-md transition-colors ${isPreview ? 'bg-green-600 text-white shadow-sm' : 'text-slate-400 hover:text-white hover:bg-slate-700'}`}
              title="Preview Mode"
            >
              <MonitorPlay size={16} />
            </button>
