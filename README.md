...
- **Preview Mode** 🆕▶️: Instantly switch to an interactive preview to test widget states (buttons, switches, inputs) and screen traversal (navigation events) without leaving the editor.
- **Canvas Zoom** 🆕🔍: Zoom in and out (`Alt + Scroll`) to work on fine details or view the entire project map.
- **AI Widget Generator** 🧠: Create widgets instantly by describing them in plain English.
- **Smart Alignment** 📏: Magnetic guidelines snap widgets to edges and centers.
...
- **Global Theming**: Instantly style your entire project with presets like _Cyberpunk_, _Midnight_, _Retro_, and more.
...
2.  Type a description like _"A large red stop button with round corners"_ or _"Blue WiFi icon"_.
