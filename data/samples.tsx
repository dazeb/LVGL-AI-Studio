...
import { Thermometer, Music, Gauge, Activity, Wifi, Keyboard, Printer, Zap, LayoutTemplate, Grid, List, MousePointer2, Layers, Home, Play } from 'lucide-react';
...
export const SAMPLE_PROJECTS: SampleProject[] = [
  ...
  },
  {
    id: 'lvgl_benchmark',
    name: 'Benchmark',
    description: 'Performance test screen with weighted FPS counter.',
    icon: <Gauge size={24} />,
    image: '/demos/benchmark.png',
    color: 'from-blue-500 to-cyan-500',
    settings: { width: 480, height: 320, defaultBackgroundColor: '#f0f0f0', projectName: 'Benchmark', theme: 'light', targetDevice: 'custom' },
    screens: [
      {
        id: 'scr_bench',
        name: 'Benchmark',
  ...
  },
  {
    id: 'smart_home_hub',
    name: 'Smart Home Hub',
    description: 'Central dashboard with room navigation (Living, Kitchen).',
    icon: <Home size={24} />,
